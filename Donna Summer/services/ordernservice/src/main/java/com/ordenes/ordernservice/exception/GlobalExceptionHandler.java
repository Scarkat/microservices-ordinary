package com.ordenes.ordernservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<com.ordenes.ordernservice.response.GeneralResponse<Map<String, String>>> handleValidationExceptions(MethodArgumentNotValidException ex) {
    ...
    public ResponseEntity<GeneralResponse<String>> handleAllUncaughtException(Exception ex) {
        ...
        if (ex.getMessage() != null && (ex.getMessage().contains("STOCK_INSUFICIENE") || ex.getMessage().contains("STOCK_INSUFFICIENTE") || ex.getMessage().contains("ERROR_COMUNICACION"))) {
