...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, OrdenKafkaDto> producerFactory() {
        ObjectMapper mapper = new ObjectMapper();
        JsonSerializer<OrdenKafkaDto> serializer = new JsonSerializer<>(mapper);
    ...
    @Bean
    public KafkaTemplate<String, OrdenKafkaDto> kafkaTemplate() {
